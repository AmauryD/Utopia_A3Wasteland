...
[
	...
	["SPAR-16 Rifle", "arifle_SPAR_01_blk_F", 1000],
	["SPAR-16 Rifle (Khaki)", "arifle_SPAR_01_khk_F", 1000],
	["SPAR-16 Rifle (Sand)", "arifle_SPAR_01_snd_F", 1000],
	...
	["CAR-95 Rifle", "arifle_CTAR_blk_F", 1200],
	["CAR-95 Rifle (Hex)", "arifle_CTAR_hex_F", 1200],
	["CAR-95 Rifle (G Hex)", "arifle_CTAR_ghex_F", 1200],
	["CAR-95 GL Rifle", "arifle_CTAR_GL_blk_F", 1250],
	["CAR-95 GL Rifle (Hex)", "arifle_CTAR_GL_hex_F", 1250],
	["CAR-95 GL Rifle (G Hex)", "arifle_CTAR_GL_ghex_F", 1250],
	["Type 115 Rifle", "arifle_ARX_blk_F", 1300],
	["Type 115 Rifle (Hex)", "arifle_ARX_hex_F", 1300],
	["Type 115 Rifle (G Hex)", "arifle_ARX_ghex_F", 1300],
	...
	// Marksman Rifles
	["MXM Rifle", "arifle_MXM_F", 1500],
	["MXM Rifle (Black)", "arifle_MXM_Black_F", 1500],
	["MXM Rifle (Khaki)", "arifle_MXM_khk_F", 1500, "noDLC"],
	["Rahim DMR Rifle", "srifle_DMR_01_F", 1700],
	["Mk18 ABR Rifle", "srifle_EBR_F", 1700],

	// DLC
	["CMR-76 Rifle", "srifle_DMR_07_blk_F", 1200],
	["CMR-76 Rifle (Hex)", "srifle_DMR_07_hex_F", 1200],
	["CMR-76 Rifle (G Hex)", "srifle_DMR_07_ghex_F", 1200],
	["SPAR-17 Rifle", "arifle_SPAR_03_blk_F", 1000],
	["SPAR-17 Rifle (Khaki)", "arifle_SPAR_03_khk_F", 1000],
	["SPAR-17 Rifle (Sand)", "arifle_SPAR_03_snd_F", 1000],

	["Mk14 Rifle (Camo)", "srifle_DMR_06_camo_F", 1000],
	["Mk14 Rifle (Olive)", "srifle_DMR_06_olive_F", 1000],
	["Mk-I EMR Rifle", "srifle_DMR_03_F", 1200],
	["Mk-I EMR Rifle (Camo)", "srifle_DMR_03_multicam_F", 1200],
	["Mk-I EMR Rifle (Khaki)", "srifle_DMR_03_khaki_F", 1200],
	["Mk-I EMR Rifle (Sand)", "srifle_DMR_03_tan_F", 1200],
	["Mk-I EMR Rifle (Woodland)", "srifle_DMR_03_woodland_F", 1200],
	["MAR-10 Rifle", "srifle_DMR_02_F", 1200],
	["MAR-10 Rifle (Camo)", "srifle_DMR_02_camo_F", 1200],
	["MAR-10 Rifle (Sand)", "srifle_DMR_02_sniper_F", 1200],
	...
	["M320 LRR Sniper (Tropic)", "srifle_LRR_tna_LRPS_F", 2200 , "noDLC"],
...
[
	...
	["APERS mine dispenser","APERSMineDispenser_Mag",5000],
...
[
	...
	["PRESS helmet (neck protection)","H_PASGT_neckprot_blue_press_F",120,"hat"],
	["PRESS helmet","H_PASGT_basic_blue_press_F",100,"hat"],
	...
	["Hard Hat (Yellow, Ear Protectors)","H_Construction_earprot_yellow_F",50,"hat"],
	["Hard Hat (White, Ear Protectors)","H_Construction_earprot_white_F",50,"hat"],
	["Hard Hat (Orange, Ear Protectors)","H_Construction_earprot_orange_F",50,"hat"],
	["Hard Hat (Red, Ear Protectors)","H_Construction_earprot_red_F",50,"hat"],
	["Hard Hat (Yellow, Headset)","H_Construction_headset_yellow_F",75,"hat"],
	["Headset (Yellow)","H_HeadSet_yellow_F",50,"hat"]
];
...
[
	...
	["EOD Vest (Olive)","V_EOD_olive_F",-1,"vest"],
...
[
	...
	["Messenger Bag (Coyote)","B_Messenger_Coyote_F",200,"backpack"],
	["Messenger Bag (Olive)","B_Messenger_Olive_F",500,"backpack"],
	["Messenger Bag (Black)","B_Messenger_Black_F",500,"backpack"],
	["Messenger Bag (IDAP)","B_Messenger_IDAP_F",500,"backpack"],
	["Messenger Bag (Gray)","B_Messenger_Gray_F",500,"backpack"],

	["Leg Strap Bag (Black)","B_LegStrapBag_black_F",500,"backpack"],
	["Leg Strap Bag (Coyote)","B_LegStrapBag_coyote_F",500,"backpack"],
	["Leg Strap Bag (Olive)","B_LegStrapBag_olive_F",500,"backpack"],
...
[
	...
	["UAV Bag [IDAP]","C_IDAP_UAV_01_backpack_F",1000,"backpack"],
	["UAV Bag (AL-6) [NATO]","B_UAV_06_backpack_F",1000,"backpack"],
	["UAV Bag (AL-6) [CSAT]","O_UAV_06_backpack_F",1000,"backpack"],
	["UAV Bag (AL-6) [AAF]","I_UAV_06_backpack_F",1000,"backpack"],
	["UAV Bag (AL-6) [IDAP]","C_IDAP_UAV_06_backpack_F",1000,"backpack"],
	["UAV Bag (Demining) [IDAP]","C_IDAP_UAV_06_antimine_backpack_F",100000,"backpack"],

	["UAV Bag (AL-6, Medical) [NATO]","B_UAV_06_medical_backpack_F",10000,"backpack"],
	["UAV Bag (AL-6, Medical) [CSAT]","O_UAV_06_medical_backpack_F",10000,"backpack"],
	["UAV Bag (AL-6, Medical) [AAF]","I_UAV_06_medical_backpack_F",10000,"backpack"],
	["UAV Bag (AL-6, Medical) [IDAP]","C_IDAP_UAV_06_medical_backpack_F",10000,"backpack"],
...
[
	...
	["Van transport","C_Van_02_transport_F", 1500, "vehicle", "SKIPSAVE"],
	["Van","C_Van_02_vehicle_F", 1500, "vehicle", "SKIPSAVE"],
	["Van medivac","C_Van_02_medevac_F", 1500, "vehicle", "SKIPSAVE"],
	["Van","B_G_Van_02_vehicle_F", 1500, "vehicle", "SKIPSAVE"],
	["Van transport (WEST)","B_G_Van_02_transport_F", 1500, "vehicle", "SKIPSAVE"],
	["Van transport (EAST)","O_G_Van_02_vehicle_F", 1500, "vehicle", "SKIPSAVE"],
	["Van transport (civilian)","I_C_Van_02_vehicle_F", 1500, "vehicle", "SKIPSAVE"],
	["Van transport (GUER)","I_G_Van_02_vehicle_F", 1500, "vehicle", "SKIPSAVE"],
	["Van transport","I_C_Van_02_transport_F", 1500, "vehicle", "SKIPSAVE"],
	["Van transport","I_G_Van_02_transport_F", 1500, "vehicle", "SKIPSAVE"],
...
[
	...
	["Mi-48 Kajman", "O_Heli_Attack_02_dynamicLoadout_F", 70000, "vehicle"] // Mi-28 with gunner 
];
...
[
	...
	["A-143 Buzzard AA", "I_Plane_Fighter_03_dynamicLoadout_F", 30000, "vehicle", "variant_buzzardAA"],
	...
	["F/A-181 Black Wasp (Gun-Only)", "B_Plane_Fighter_01_Stealth_F", 60000, "vehicle"], // no missiles or bombs
	["F/A-181 Black Wasp", "B_Plane_Fighter_01_F", 70000, "vehicle"],

	["To-201 Shikra (Gun-Only)", "O_Plane_Fighter_02_Stealth_F", 60000, "vehicle"], // no missiles or bombs
	["To-201 Shikra", "O_Plane_Fighter_02_F", 80000, "vehicle"],
	...
	["MQ4A Greyhawk Bomber UAV", "B_UAV_02_dynamicLoadout_F", 30000, "vehicle", "variant_greyhawkBomber"], // Bomber UAVs are a lot harder to use, hence why they are cheaper than Missile ones
	["K40 Ababil-3 Bomber UAV", "O_UAV_02_dynamicLoadout_F", 30000, "vehicle", "variant_greyhawkBomber"],
	["K40 Ababil-3 Bomber UAV", "I_UAV_02_dynamicLoadout_F", 30000, "vehicle", "variant_greyhawkBomber"],

	["KH-3A Fenghuang Missile UAV", "O_T_UAV_04_CAS_F", 40000, "vehicle"],

	["MQ4A Greyhawk Cluster UAV", "B_UAV_02_dynamicLoadout_F", 50000, "vehicle", "variant_greyhawkDAGR"],
 	["K40 Ababil-3 Cluster UAV", "O_UAV_02_dynamicLoadout_F", 50000, "vehicle", "variant_greyhawkDAGR"],
 	["K40 Ababil-3 Cluster UAV", "I_UAV_02_dynamicLoadout_F", 50000, "vehicle", "variant_greyhawkDAGR"],

	["UCAV Sentinel Missile", "B_UAV_05_F", 50000, "vehicle", "variant_sentinelMissile"],
	["UCAV Sentinel Bomber", "B_UAV_05_F", 40000, "vehicle", "variant_sentinelBomber"]
];
...
_texDir = "client\images\vehicleTextures\"; // not used anymore
...
[
	...
	["Cookie", "cookie", "The cookie is a lie , don't eat it ... EPILEPTIC WARNING", "\A3\EditorPreviews_F\Data\CfgVehicles\Land_CerealsBox_F.jpg", 30, 15],
	["Canned Food", "cannedfood", localize "STR_WL_ShopDescriptions_CanFood", "client\icons\cannedfood.paa", 30, 15],
	["Repair Kit", "repairkit", localize "STR_WL_ShopDescriptions_RepairKit", "client\icons\briefcase.paa", 500, 250],
	["Ammo Kit", "ammokit","Ammo Kit", "client\icons\briefcase.paa", 10000, 500],
	["Artillery Strike", "artillery", "", "client\icons\tablet.paa", 100000, 50000],
