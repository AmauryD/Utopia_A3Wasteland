...
ug_fnc_dynamicGroups = ["client\systems\groups","fn_dynGroups.sqf"] call mf_compile;

ug_fnc_playerAddMoney = "client\functions\fn_playerAddMoney.sqf" call mf_compile;
ug_fnc_compileRemote = ["addons\scripts\RemoteCompiler","fn_compileRemoteFunction.sqf"] call mf_compile;
ug_fnc_isTeamKill =  [_serverFunc,"fn_isTeamKill.sqf"] call mf_compile;
...
ug_fnc_setUnitLoadout = [_serverFunc, "fn_setUnitLoadout.sqf"] call mf_compile;
