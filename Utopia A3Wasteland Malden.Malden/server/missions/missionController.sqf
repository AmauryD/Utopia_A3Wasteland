...
private ["_controllerNum", "_tempController", "_controllerSuffix","_controllerRunCondition", "_missionsFolder", "_missionDelay", "_availableMissions", "_missionsList", "_nextMission"];
...
while {true} do
{
	...
	if !(isNil "_controllerRunCondition") then {
		waitUntil _controllerRunCondition;
	};
