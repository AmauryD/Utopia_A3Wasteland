...
if (isServer) then
{
	...
	[
		...
		"A3W_privateStorage",
		"A3W_privateParking",
		"A3W_privateParkingMinSlots", // [utopia] Amaury
...
[] execVM "mapConfig\createBridge.sqf";
...
// [utopia] Amaury
["deleteOldMessages"] call extDB_Database_async;

//fix rocks , hope it works 
{
	if(str _x find "limestone_01_wall" != -1) then {
		_x hideObjectGlobal true;
		_x enableSimulationGlobal false;
	};
}foreach (nearestTerrainObjects [[worldSize / 2,worldSize / 2],["ROCK"],worldSize,false]);