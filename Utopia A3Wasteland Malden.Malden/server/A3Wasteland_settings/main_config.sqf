...
A3W_vehicleLifetime = 14*24;           // Maximum lifetime in hours for saved vehicles across server restarts, regardless of usage (0 = no time limit)
...
A3W_teamMissionDelay = 60*60;       // Time in seconds between Side Missions
A3W_teamMissionTimeout = 20*60;    // Time in seconds that a Side Mission will run for, unless completed