...
player createDiaryRecord ["changelog",
[
"Utopia v1.08 [08/09/17]",
"
<br/>[Added] New misions (Jet,Team missions)
<br/>[Added] Skills menu , skill points
<br/>[Added] Level limit to 31
<br/>[Added] Garage in the north-east island (Ticket : Leo Deus)
<br/>[Added] ORANGE DLC vehicles and drones

<br/>[Changed] Reworked leveling system
<br/>[Changed] Bridge in the south west is now made of simpleObjects
<br/>[Changed] Reworked missions markers system
<br/>[Changed] Special forces now give more XP

<br/>[Removed] A lot of buggy rocks
<br/>[Removed] Aircraft carrier

<br/>[Improved] UI loading system

<br/>[Fixed] Team mission IA wasn't despawning when mission succeed
<br/>[Fixed] Vehicle was not always deleted in DB when sold
<br/>[Fixed] Mission markers despawn should be fixed (Ticket : Leo Deus)
<br/>[Fixed] Can't open group menu in spawning menu (Ticket : Yuni)
<br/>[Fixed] Battleyeeee 
"
]];
...
player createDiaryRecord ["changelog",
[
"Utopia v1.07 [16/08/17]",
"
<br/>[Added] Bounty system
<br/>[Added] Supply drop system
<br/>[Added] Can buy more parking slots , limited to 5
<br/>[Added] Bug box is now fully connected with database and should no longer make bugs
<br/>[Added] UAV fly height limit (500m)
<br/>[Added] Server rules menu
<br/>[Added] Mission markers should display in spawn menu (Ticket : Axel)
<br/>[Added] Message Box system , works for offline players

<br/>[Added] Remote Security improvement
<br/>[Added] Safe and secure add money

<br/>[changed] reworked UI 
<br/>	-player menu
<br/>	-virtual inventory 
<br/>	-controls menu
<br/>	-hall of fame
<br/>[changed] vehicle lifetime
<br/>[changed] max viewDistance (5000) (Ticket : IPOD)
<br/>[changed] level limit increased to 10
<br/>[changed] No more thermal for any vehicle

<br/>[removed] MQ12 drone

<br/>[Fixed] player should no longer spawn with 0 food or water (Ticket : chroot)
<br/>[Fixed] AI spawning at the airfield
<br/>[Fixed] Fixes from A3Wasteland github
<br/>[Fixed] Sold vehicle was not deleted in database and respawns after restart (Ticket : Léo Deus,ProDom1No1G)
"
]];
...
player createDiaryRecord ["changelog",
[
"Utopia v1.06 [10/07/17]",
"
<br/>[Added] hall Of Fame 
<br/>[Added] controls management with multiple keys
<br/>[Added] Holster weapon key (Ticket : DouD , [TWE] modelli3oita)
<br/>[Added] More boat spawn near Moray island (Ticket : notChong)
<br/>[Added] Computer hacking mission 
<br/>[Fixed] Some bugs / code optimization / map markers
"
]];
...
player createDiaryRecord ["changelog",
[
"Utopia v1.05 [29/06/17]",
"
<br/>[Added] Weapon sway reduction with level
<br/>[Added] USS Carrier , bridge , thx to guillaume54
<br/>[Added] More private storage (1 in each town)
<br/>[Changed] Player Menu
<br/>[Fixed] Some bugs and itembox optimizations
<br/>[Fixed] Max Level HUD bugs
"
]];

player createDiaryRecord ["changelog",
[
"Utopia v1.04 [27/06/17]",
"
<br/>[Added] Repair Zamak near vehStore
<br/>[Added] Surprise Cookie
<br/>[Changed] No more fog
<br/>[Changed] Garage south of Chapoi moved to Goisse.
<br/>[Fixed] Last flying building
<br/>[Fixed] Useless markers on map
<br/>[Fixed] VehStore position near Arudy
<br/>[Fixed] Inverted food bar and water bar
"
]];

player createDiaryRecord ["changelog",
[
"Utopia v1.03 [26/06/17]",
"
<br/>[Added] Bug and suggestions box
<br/>[Added] MORE ATMS
<br/>[Changed] HUD
<br/>[fixed] Blank square when dying 
<br/>[Fixed] Some flying buildings
"
]];

player createDiaryRecord ["changelog",
[
"Utopia v1.02 [25/06/17]",
"
<br/>[Added] Price reduction with rank
<br/>[Added] Objectives details on map
<br/>[Changed] Difficulty
<br/>[Fixed] Some misplaced mission markers
"
]];

player createDiaryRecord ["changelog",
[
"Utopia v1.01 [24/06/17]",
"
<br/>[Added] Information text on map
<br/>[Added] Territories
<br/>[Fixed] Xp system fixes
<br/>[Added] Underwater ojectives are closer to the coasts
<br/>[Changed] Gun Store Prices
"
]];
