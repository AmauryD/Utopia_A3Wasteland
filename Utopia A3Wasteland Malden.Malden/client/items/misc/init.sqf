...
MF_ITEMS_AMMO_KIT = "ammokit";
_repair = [_path, "ammo.sqf"] call mf_compile;
_icon = "client\icons\repair.paa";
[MF_ITEMS_AMMO_KIT, "Ammo Kit", _repair, "Land_SuitCase_F",_icon,2] call mf_inventory_create;
...
mf_repair_can_ammo = [_path, "can_ammo.sqf"] call mf_compile;
_label1 = format["<img image='%1'/> Rearm Vehicle", _icon];
_execute1 = {MF_ITEMS_AMMO_KIT call mf_inventory_use};
_condition1 = "[] call mf_repair_can_ammo == ''";
_action1 = [_label1, _execute1, [], 1, false, false, "", _condition1];
["ammokit-use", _action1] call mf_player_actions_set;
