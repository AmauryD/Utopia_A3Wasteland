...
_effectScript = [_this, "lsdCookie.sqf"] call mf_compile; //added by [utopia] Amaury
...
[MF_ITEMS_COOKIE, "Cookie", _effectScript, "Land_CerealsBox_F","\A3\EditorPreviews_F\Data\CfgVehicles\Land_CerealsBox_F.jpg", 2] call mf_inventory_create;
